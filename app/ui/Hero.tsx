...
export default function HeroSection() {
    return (
        <section id="Home" className="flex flex-row">
            <section className={`${poppins.className} flex flex-col h-[calc(95vh-5rem)] bg-bg-1 text-red sm:w-full lg:w-4/6 2xl:w-3/5 justify-center items-center text-center lg:text-left gap-10`}>
